...
export class GameController {
  constructor({ gameService, messageService, gameLogic }) {
  ...
  @withLog()
  @wrap()
  async generateGameState(req, res) {
    const { state, column } = req.body;
    res.send(this.gameLogic.handleGameAction(state, column));
  }
}
